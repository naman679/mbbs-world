...
// when the user scrolls up to view previous content.
// -----------------------------------------------------------------------------
let _touchStartY = 0;
...
document.addEventListener('touchmove', e => {
    ...
    // Check if the scroll container is at the very top
    const contentArea = document.getElementById('contentArea');
    const isAtTop = contentArea ? contentArea.scrollTop <= 0 : window.scrollY <= 0;
    
    // If dragging down while at the top of the container, block the native pull-to-refresh
