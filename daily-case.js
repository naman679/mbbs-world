...
// when the user scrolls up to view previous messages.
// -----------------------------------------------------------------------------
let _touchStartY = 0;
...
document.addEventListener('touchmove', e => {
    ...
    // Check if the chat container is at the very top
    const chatBox = document.getElementById('chatContainer');
    const isAtTop = chatBox ? chatBox.scrollTop <= 0 : window.scrollY <= 0;
